...
public class SpiderMonkeyOptimization {
    ...
    public SpiderMonkeyOptimization(MDMTSP mdmtsp, int totalNumberOfIterations, int totalNumberOfSpiderMonkey, int allowedMaximumGroup, double perturbationRate, int localLeaderLimit, int globalLeaderLimit) {
        this.mdmtsp = mdmtsp;
