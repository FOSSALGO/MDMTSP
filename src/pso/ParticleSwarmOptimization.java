...
public class ParticleSwarmOptimization {
    ...
    public ParticleSwarmOptimization(MDMTSP mdmtsp, int totalNumberOfIterations, int totalNumberOfSpiderMonkey, int allowedMaximumGroup, double perturbationRate, int localLeaderLimit, int globalLeaderLimit) {
        this.mdmtsp = mdmtsp;
